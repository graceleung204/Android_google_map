...
public class GPSTracker implements OnSuccessListener<Location>
{
    ...
    public void showSettingAlert()
    {
        ...
        alertDialog.setNegativeButton("Cancel", (dialog, which) -> dialog.cancel()); alertDialog.show();
    }
    ...
    public void onSuccess(Location location)
    {
        if (location != null)
        {
            ...
            Toast.makeText(context, "Grace is at \n" + "Lat " + latitude + "\nLong: " + longitude, Toast.LENGTH_LONG).show();
        }
        else Toast.makeText(context, "Unable to get location", Toast.LENGTH_LONG).show();
    }
